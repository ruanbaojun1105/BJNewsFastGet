...
//    public static String server="http://39.108.182.251:28080/";
    ...
    //异步线程池无优先级请求
    public static void postExecuteThead(AbstractRequest abstractRequest, final HttpListener httpListener) {
        AsyncRequestExecutor.INSTANCE.execute(0, abstractRequest, new DefaultResponseListener(httpListener, abstractRequest));
    }
