...
import com.bj.newsfastget.html.HtmlXmlAgreeEntity;
import com.bj.newsfastget.html.HtmlXmlAuthorEntity;
import com.bj.newsfastget.html.HtmlXmlCommentEntity;
import com.bj.newsfastget.html.HtmlXmlImgEntity;
import com.bj.newsfastget.html.HtmlXmlImgsEntity;
import com.bj.newsfastget.html.HtmlXmlLayerEntity;
import com.bj.newsfastget.html.HtmlXmlLinkEntity;
import com.bj.newsfastget.html.HtmlXmlTitleEntity;
...
import static com.bj.newsfastget.html.HtmlBaseEntity.ATTRIBUTE_HREF;
import static com.bj.newsfastget.html.HtmlBaseEntity.ATTRIBUTE_SRC;
import static com.bj.newsfastget.html.HtmlBaseEntity.TAG_A_SELECT;
import static com.bj.newsfastget.html.HtmlBaseEntity.TAG_IMG_SELECT;
...
public class HtmlParseToEntityHandle {
    ...
    public Observable<List<NewsItemEntity>> parse() {
        ...
        return HtmlHandle.getHtml(originUrl).map(new Function<Document, List<NewsItemEntity>>() {
            @Override
            public List<NewsItemEntity> apply(Document document) {
                originDoc = document;
